...
class Date:
    ...
    def __eq__(self, other):
        """ returns True if the called object (self) and the argument 
            (other) represent the same calendar date
        """
    ...
    def is_before(self, other):
        """ returns True if the called object represents a calendar 
            date that occurs before the calendar date that is represented
            by other. If self and other represent the same day, or if self 
            occurs after other, the method should return False.
        """
    ...
    def is_after(self, other):
        """ returns True if the calling object represents a calendar 
            date that occurs after the calendar date that is represented 
            by other. If self and other represent the same day, or if self 
            occurs before other, the method should return False.
        """
    ...
    def days_between(self, other):
        ...
        s2 = other.copy()
        result = 0
        while s1.is_before(s2) == True:
            result -= 1
            s1.advance_one()
        while s1.is_after(s2) == True:
            result += 1
            s2.advance_one()
        return result
    ...
    def day_name(self):
        ...
        n = self.days_between(Date(11, 9, 2020)) % 7
        return day_names[n]
